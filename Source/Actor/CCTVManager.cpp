...
{
	GEngine->AddOnScreenDebugMessage(131, 30.f, FColor::Red, TEXT("next"));
	if (bInteracting)
	{
		GEngine->AddOnScreenDebugMessage(131, 30.f, FColor::Red, TEXT("next2"));
...
{
	GEngine->AddOnScreenDebugMessage(141, 30.f, FColor::Red, TEXT("prev"));
	if (bInteracting)
	{
		GEngine->AddOnScreenDebugMessage(141, 30.f, FColor::Red, TEXT("prev2"));
