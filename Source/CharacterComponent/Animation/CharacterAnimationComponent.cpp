...
void UCharacterAnimationComponent::PlayFireMontage(bool bAiming)
{
	...
	if (AnimInstance && FireWeaponMontage)
	{
		...
		FName SectionName = bAiming ? FName("Rifle_C_Aim") : FName("Rifle_C_Idle");
...
{
	if (!OwnerShooterCharacter || !OwnerShooterCharacter->GetWeaponManager()) return;
